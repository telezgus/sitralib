...
class CompilaEnvioEstructuraParteAlta(object):
    """
    ...
    def create(self, **kwargs):
        ...
        trama[9] = '69'  # Codigo según Protocolo
        trama[10] = '00'
        trama[11] = 'F6'
    ...
    def __set_intervalo(self, **kwargs):
        ...
        a = [
            ...
            mov[14] + mov[13],
            mov[16] + mov[15],
            self.helpers.sanitizeHex(data['fun'][int_valor], 2),
            '00',
            '00',
            '00',
            self.__set_parametro_4(data['fun'][int_valor])
        ]
        return a
